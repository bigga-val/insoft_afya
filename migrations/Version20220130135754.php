 ...
 */
final class Version20220130135754 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hopital ADD person_id INT NOT NULL');
        $this->addSql('ALTER TABLE hopital ADD CONSTRAINT FK_8718F2C217BBB47 FOREIGN KEY (person_id) REFERENCES person (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8718F2C217BBB47 ON hopital (person_id)');
        ...
        $this->addSql('ALTER TABLE user ADD created_at DATETIME DEFAULT NULL, ADD created_by VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8718F2C217BBB47 ON hopital');
        $this->addSql('ALTER TABLE hopital DROP person_id');
        $this->addSql('ALTER TABLE medecin_service_hopital DROP FOREIGN KEY FK_215921605A5E8626');
        $this->addSql('ALTER TABLE `user` DROP created_at, DROP created_by');
    }
}
